                            ...
                            <div class="product-wrapper">
                                <div class="thumb-wrapper">
                                    <?=\yii\helpers\Html::a('<span class="face">'
                                        ...
                                        , ['product/view', 'slug' => $node->slug], ['class' => 'thumb flip']); ?>
                                </div>
                            </div>
                            <div class="item-info">
                                <div class="info-inner">
                                    <div class="item-title"><?=\yii\helpers\Html::a($node->title, ['product/view', 'slug' => $node->slug]);?></div>
                                </div>
                            </div>
                        </div>
                    </div>
